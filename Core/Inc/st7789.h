...
#define ST7789_DC_PORT  LCD_SCK_GPIO_Port
...
#define ST7789_BLK() 		HAL_GPIO_WritePin(BLK_PORT, BLK_PIN, GPIO_PIN_SET)
#define ST7789_UnBLK() 		HAL_GPIO_WritePin(BLK_PORT, BLK_PIN, GPIO_PIN_RESET)
#else
