...
void MX_FDCAN1_Init(void)
{
  ...
  /* USER CODE BEGIN FDCAN1_Init 2 */
	...
	FDCAN1_RXFilter.FilterID2=0x0000;                               //如果FDCAN配置为传统模式的�?,这里�?32位掩�?
	...
	HAL_FDCAN_ActivateNotification(&hfdcan1,FDCAN_IT_RX_FIFO0_NEW_MESSAGE,0);	//�?启CAN通知
...
/* USER CODE BEGIN 1 */
//can发�?�一组数据帧(固定格式:ID�?0X12,标准�?,数据�?)	
//len:数据长度(�?大为8),可设置为FDCAN_DLC_BYTES_2~FDCAN_DLC_BYTES_8				     
//msg:数据指针,�?大为8个字�?.
//返回�?:0,成功;
//		 其他,失败;
